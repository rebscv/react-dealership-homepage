...
function HomePage() {
  ...
  const isVersion2 = version === "version-2";
                ...
                <div className="grid">
                  ...
                  <div>
                    <div className="btn-flex">
                      <Link to={`/${version}/about`} className="btn btn-primary">Learn More</Link>
                      <Link to={`/${version}/contact`} className="btn btn-primary">Contact Us</Link>
                    </div>
                  </div>
